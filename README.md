...
3. Package the standalone bundle in `dist/SaikoSoundboard-v0.4.1-beta/`.
4. Build `SaikoSoundboard-0.4.1-Beta-Setup.exe` if Inno Setup Compiler (`iscc.exe`) is installed.
