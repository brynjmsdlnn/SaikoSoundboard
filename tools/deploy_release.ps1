# PowerShell Deployment Script for SaikoSoundboard Beta v0.2.0
...
$StagingDir = "$DistDir\SaikoSoundboard-v0.2.0-beta"
$InstallerScript = "$ProjectRoot\installer\SaikoSoundboard.iss"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host " SaikoSoundboard Release Deployment v0.2.0" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
$ZipPath = "$DistDir\SaikoSoundboard-v0.2.0-beta-portable.zip"
